...
public:
  ...
  static_assert(!detail::is_specialization_of<E, unexpected>::value, "E must not be a specialization of unexpected");
  static_assert(!std::is_const_v<E> && !std::is_volatile_v<E>, "E must not be cv-qualified");
  ...
  requires(std::is_constructible_v<E, std::initializer_list<U>&, Args...>) constexpr explicit unexpected(
      std::in_place_t, std::initializer_list<U>, Args&&... args)
...
public:
  const char* what() const noexcept override { return "bad void expected access"; }
};
...
public:
  ...
  constexpr expected() requires std::is_default_constructible_v<E> : has_val_(true), val_() {}
  ...
  constexpr expected(const expected&) requires(
      std::is_trivially_copy_constructible_v<T>&& std::is_trivially_copy_constructible_v<E>) = default;

  constexpr expected(expected&& rhs) noexcept(
      std::is_nothrow_move_constructible_v<T>&& std::is_nothrow_move_constructible_v<
          E>) requires(std::is_move_constructible_v<T>&& std::is_move_constructible_v<E>) {
    if (rhs.has_value())
  ...
  constexpr expected(expected&&) requires(
      std::is_trivially_move_constructible_v<T>&& std::is_trivially_move_constructible_v<E>) = default;

  template <class U, class G, class UF = const U&, class GF = const G&>
  requires(std::conjunction_v< std::is_constructible<T, UF>, std::is_constructible<E, GF>,
  ...
  requires(!std::is_same_v<std::remove_cvref_t<U>, std::in_place_t> &&
           ...
           std::is_constructible_v<T, U>) constexpr explicit(!std::is_convertible_v<U, T>) expected(U&& v)
  ...
  constexpr explicit expected(std::in_place_t, Args&&... args) : has_val_(true), val_(std::forward<Args>(args)...) {}

  template <class U, class... Args>
  requires(std::is_constructible_v<T, std::initializer_list<U>&, Args...>) constexpr explicit expected(
      std::in_place_t, std::initializer_list<U> il, Args&&... args)
      : has_val_(true), val_(il, std::forward<Args>(args)...) {}

  template <class... Args>
  requires std::is_constructible_v<E, Args...>
  constexpr explicit expected(unexpect_t, Args&&... args) : has_val_(false), unex_(std::forward<Args>(args)...) {}

  template <class U, class... Args>
  requires(std::is_constructible_v<E, std::initializer_list<U>&, Args...>) constexpr explicit expected(
  ...
  constexpr ~expected() requires(
      std::conjunction_v<std::is_trivially_destructible<T>, std::is_trivially_destructible<E>>) = default;
  ...
  constexpr expected& operator=(const expected&) //
      requires(!std::conjunction_v<
               std::is_copy_assignable_v<T>, std::is_copy_constructible<T>, std::is_copy_assignable<E>,
               std::is_copy_constructible<E>,
               std::disjunction<std::is_nothrow_move_constructible<E>, std::is_nothrow_move_constructible<T>>>) =
          delete;

  constexpr expected& operator=(expected&& rhs) //
      noexcept(std::conjunction_v<std::is_nothrow_move_assignable<E>, std::is_nothrow_move_constructible<E>,
                                  std::is_nothrow_move_assignable<T>,
                                  std::is_nothrow_move_constructible<T>>) //
      requires(std::conjunction_v<
               std::is_move_constructible<T>, std::is_move_assignable<T>, std::is_move_constructible<E>,
               std::is_move_constructible<E>,
               std::disjunction<std::is_nothrow_move_constructible<T>, std::is_nothrow_move_constructible<E>>>) {
    if (has_val_ && rhs.has_val_)
      val_ = std::move(*rhs);
    else if (has_val_)
  ...
  template <class U = T>
  requires(
      std::conjunction_v< std::negation<std::is_same<expected, std::remove_cvref_t<U>>>,
                          detail::is_specialization_of<std::remove_cvref_t<U>, unexpected>, std::is_constructible<T, U>,
                          std::is_assignable<T&, U>,
                          std::disjunction<std::is_nothrow_constructible<T, U>, std::is_nothrow_move_constructible<T>,
  ...
  requires(
      std::conjunction_v<std::is_constructible<E, GF>, std::is_assignable<E&, GF>,
                         std::disjunction<std::is_nothrow_constructible<E, GF>, std::is_nothrow_move_constructible<T>,
                                          std::is_nothrow_move_constructible<E>>>) //
      constexpr expected&
  ...
  &, Args... > constexpr T& emplace(std::initializer_list<U> li, Args&&... args) noexcept {
    if (has_val_)
      std::destroy_at(std::addressof(val_));
    else {
      std::destroy_at(std::addressof(val_));
    ...
    return *std::construct_at(std::addressof(val_), li, std::forward<Args>(args)...);
  }

  constexpr void swap(expected& rhs) //
      noexcept(std::conjunction_v<std::is_nothrow_move_constructible<T>, std::is_nothrow_swappable<T>,
                                  std::is_nothrow_move_constructible<E>, std::is_nothrow_swappable<E>>) requires
      std::conjunction_v<
          std::is_swappable<T>, std::is_swappable<E>, std::is_move_constructible<T>, std::is_move_constructible<E>,
          std::disjunction<std::is_nothrow_move_constructible<T>, std::is_nothrow_move_constructible<E>>> {
    if (has_val_ && rhs.has_val_) {
      using std::swap;
      swap(val_, rhs.val_);
  ...
  constexpr T value_or(U&& v) const& {
    static_assert(std::conjunction_v<std::is_copy_constructible<T>, std::is_convertible<U, T>>);
  ...
  constexpr T value_or(U&& v) && {
    static_assert(std::conjunction_v<std::is_move_constructible<T>, std::is_convertible<U, T>>);

    return has_val_ ? std::move(**this) : static_cast<T>(std::forward<U>(v));
  }

  template <class T2, class E2>
  requires(!std::is_void_v<T2>) friend constexpr bool operator==(const expected& x, const expected<T2, E2>& y) {
    // TODO Mandates
...
public:
  ...
  constexpr expected(const expected&) requires(!std::is_copy_constructible_v<E>) = delete;

  constexpr expected(const expected&) requires(std::is_trivially_copy_constructible_v<E>) = default;
  ...
  constexpr expected(expected&& rhs) requires(std::is_trivially_move_constructible_v<E>) = default;
  ...
  requires(std::conjunction_v<std::is_void<U>, std::is_constructible<E, GF>,
                              ...
                              std::negation< std::is_constructible<unexpected<E>, const expected<U, G>&>>,
                              std::negation< std::is_constructible<unexpected<E>, const expected<U, G>>>>) //
      constexpr explicit(!std::is_convertible_v<GF, E>) expected(const expected<U, G>& rhs)
      : has_val_(rhs.has_val_) {
    if (!has_val_)
  ...
  requires(std::conjunction_v<std::is_void<U>, std::is_constructible<E, GF>,
                              ...
                              std::negation< std::is_constructible<unexpected<E>, const expected<U, G>&>>,
                              std::negation< std::is_constructible<unexpected<E>, const expected<U, G>>>>) //
      constexpr explicit(!std::is_convertible_v<GF, E>) expected(expected<U, G>&& rhs)
      : has_val_(rhs.has_val_) {
    if (!has_val_)
      std::construct_at(std::addressof(unex_), std::forward<GF>(rhs.error()));
  }
  ...
  template <class G, class GF = const G&>
  requires(std::is_constructible_v<E, GF>) constexpr explicit(std::is_convertible_v<GF, E>)
  ...
  template <class G, class GF = G>
  requires(std::is_constructible_v<E, GF>) constexpr explicit(std::is_convertible_v<GF, E>) expected(unexpected<G>&& e)
      : has_val_(false) {
    std::construct_at(std::addressof(unex_), std::forward<GF>(e.value()));
  }
  ...
  template <class... Args>
  requires(std::is_constructible_v<E, Args...>) constexpr explicit expected(unexpect_t, Args&&... args)
  ...
  constexpr expected& operator=(const expected&) requires(
      !std::conjunction_v<std::is_copy_assignable<E>, std::is_copy_constructible<E>>) = delete;
  ...
  constexpr expected& operator=(expected&&) requires(
      !std::conjunction_v<std::is_move_assignable<E>, std::is_move_constructible<E>>) = delete;

  template <class G, class GF = const G&>
  requires(std::conjunction_v<std::is_constructible<E, GF>, std::is_assignable<E&, GF>>) constexpr expected&
  operator=(const unexpected<G>& e) {
    if (has_val_) {
      std::construct_at(std::addressof(unex_), std::forward<GF>(e.value()));
      has_val_ = false;
  ...
  constexpr void swap(expected& rhs) noexcept(std::conjunction_v<std::is_nothrow_move_constructible<E>,
                                                                 std::is_nothrow_swappable<E>>) //
      requires(std::conjunction_v<std::is_swappable<E>, std::is_move_constructible<E>>) {
    if (has_val_ && rhs.has_val_) {
      // No effect.
    } else if (has_val_ && !rhs.has_val_) {
      std::construct_at(std::addressof(unex_), std::move(rhs.unex_));
